  ...
  <div class="main-context">
    <el-card class="box-card">
      <el-space direction="vertical" style="width: 100%" size="large">
        <el-space>
          <img src="../assets/7-20092H1324Oa.jpg" width="100%" style="width: 55px">   
          <el-space direction="vertical" style="width: 100%" size="small">
            <h2 style="font-style: oblique">联想笔记本商城</h2>
            <span style="font-style: oblique;font-size: 15px"></span>
          </el-space>
        </el-space>
...
.main-context {
  ...
  background: url("../assets/登录页背景.jpg") no-repeat center center fixed;   /*背景*/
